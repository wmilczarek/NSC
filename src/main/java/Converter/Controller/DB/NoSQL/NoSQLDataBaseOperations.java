...
public abstract class NoSQLDataBaseOperations {
    ...
    public abstract List<String> loadDataBase(String dbName) throws UnknownHostException;
    ...
    public abstract List<String> showTypes(String entityName, String fieldName);
